                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-green-100 text-green-700 p-3 rounded-full">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14v7m-7-7h14" />
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-bold text-gray-800">{{ $users->where('status', 'Active')->count() }}</p>
                    </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-bold text-gray-800">{{ $users->where('role', 'Student')->count() }}</p>
                    </div>
                    <div class="bg-yellow-100 text-yellow-700 p-3 rounded-full">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-2.21 0-4 1.79-4 4v4h8v-4c0-2.21-1.79-4-4-4zM6 20h12" />
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-bold text-gray-800">{{ $users->filter(fn($u) => $u->created_at->month === now()->month)->count() }}</p>
                    </div>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 id">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-sm font-bold text-gray-800 name">{{ $user->name }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $user->email }}</td>
                        <td class="px-6 py-4 role">
                            <span class="px-3 py-1 text-xs font-bold rounded-full bg-green-100 text-green-700">{{ $user->role ?? 'Student' }}</span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700">{{ $user->status ?? '' }}</span>
                        </td>
                        <td class="px-6 py-4 text-right space-x-2">
                            <button type="button" class="text-gray-400 hover:text-green-700 transition edit-button" title="Edit User"
            ...
            <form id="addUserForm" method="POST" action="{{ route('system-admin.users.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name"
                        class="w-full border border-green-700 rounded-xl px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-700"
                        required>
                </div>
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" id="closeAddModal"
                        class="px-4 py-2 rounded-xl border border-gray-300 hover:bg-gray-100 transition">Cancel</button>
                    <button type="submit"
                        class="px-4 py-2 rounded-xl bg-green-700 text-white hover:bg-green-800 transition">Add
                        User</button>
                </div>
            </form>
        </div>
            ...
            <form id="editUserForm" method="POST" action="">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="editUserName"
                        class="w-full border-gray-300 rounded-xl px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-700"
                        required>
                </div>
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button type="submit"
                        class="px-4 py-2 rounded-xl bg-green-700 text-white hover:bg-green-800 transition">
                        Save Changes
                    </button>
                </div>
            </form>
