...
<nav class="flex-1 overflow-y-auto p-4 text-sm space-y-1">
    ...
    <a href="{{ route('registrar.index') }}"
        ...
        {{ request()->routeIs('registrar.dashboard') ? 'bg-white text-[#057E2E] font-bold shadow-md' : 'text-white hover:bg-white hover:text-[#057E2E] hover:font-semibold' }}">
        <span>Dashboard</span>
    </a>
    ...
    <a href="{{ route('registrar.sections.index') }}"
        class="flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition
        {{ request()->routeIs('registrar.sections.*') ? 'bg-white text-[#057E2E] font-bold shadow-md' : 'text-white hover:bg-white hover:text-[#057E2E] hover:font-semibold' }}">
        <span>Sections</span>
    </a>
    ...
    <a href="{{ route('registrar.grades.index') }}"
        class="flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition
        {{ request()->routeIs('registrar.grades.*') ? 'bg-white text-[#057E2E] font-bold shadow-md' : 'text-white hover:bg-white hover:text-[#057E2E] hover:font-semibold' }}">
        <span>Grades</span>
    </a>
